...
public class EmailUtils 
{
	...
	//private static final String emailFromAddress = "sumant.rajpathak@gmail.com";
	...
	public static void sendSSLMessage(String recipients[], String subject, String bodyMessage, String from, String attachment) 
	throws Exception
	{
		boolean debug = true;
		...
		Session session = Session.getDefaultInstance(props, 
								...
								{	
									...
									{
										return new PasswordAuthentication("dalee.bisenmca@gmail.com", "Pramod22%");
									}
								});
	...
	public static void sendSSLMessageMultipleAttachments(String recipients[], String subject, String bodyMessage, String from, String []attachments) 
	throws Exception
	{
		boolean debug = true;
