...
<s:form id="editDeveloper" name="editDeveloper" action="saveDeveloper.action">
						...
						<input type="hidden" name="oid" value="${oid}"/>
	            			<table style="width: 100%;">
		                         ...
		                         <tr>
		                         	...
		                         	<td style="width: 51%;">
		                         		<table>
											<s:textfield key="developerName" label="" labelSeparator="" maxlength="14" size="20"  onkeyup="acceptOnlyCharacter(this)"/>		                         		
		                         		</table>
		                         	</td>
		                        </tr>
