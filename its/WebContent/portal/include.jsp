...
<%@page import="com.its.util.GenericUtils"%><style media="all" type="text/css">@import "${pageContext.request.contextPath}/css/menu_style.css";</style>
<!-- jmesa css -->
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/demos.css" media="all" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/jquery-ui-1.8.23.custom.css" media="all" />
