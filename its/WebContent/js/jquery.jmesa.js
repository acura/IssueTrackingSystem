(function ($) {
    ...
    var coreapi = {
        ...
        setTotalRowsToLimit : function(id, totalRows) {
        	 var totalRows = this.getTableFacade(id).limit.setTotalRows(totalRows);
        ...
        setExportToLimit : function(id, exportType, totalRows) {
        ...
        createHiddenInputFieldsForLimitAndSubmit : function(id, totalRows) {
            var tableFacade = this.getTableFacade(id, totalRows);
            var form = getFormByTableId(id);
        ...
        createParameterStringForLimit : function(id, totalRows) {
            var tableFacade = this.getTableFacade(id);
    ...
    $.extend(classes.Limit.prototype, {
        ...
        getTotalPages : function (id, totalRows) {
	        if (this.maxRows == 0) return 1;
            var pages = totalRows / this.maxRows;
	        if ((totalRows % this.maxRows) > 0) {
		        ++pages;
	        }
	        return pages;
        },
